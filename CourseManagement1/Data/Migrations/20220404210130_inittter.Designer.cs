...
namespace CourseManagement.Data.Migrations
{
    ...
    [Migration("20220404210130_inittter")]
    partial class inittter
    {
            ...
            modelBuilder.Entity("CourseManagement.Models.StudentSubject", b =>
                {
                    ...
                    b.HasOne("CourseManagement.Models.Subject", null)
                        .WithMany("TeacherSubjects1")
